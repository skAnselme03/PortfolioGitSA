...
<body>
	...
	<section>
	    ...
	    <form action="${pageContext.request.contextPath}/gestionCategorie" method="post">
	        ...
	        <tbody>
	            <c:forEach items="${categories}" var="categorie">
				    <tr>
				        ...
				        <td>
				            <form action="${pageContext.request.contextPath}/gestionCategorie" method="post" style="display: inline;">
