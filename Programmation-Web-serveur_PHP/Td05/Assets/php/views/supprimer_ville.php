...
<html lang="fr">
	<head>
		...
		<title>Travail dirigé 05/question 7</title>
	</head>
	<body>
		<header>
			<h1>TD 5: Question 7</h1>
			<nav>
		...
		<?php require("../controllers/pourSupprimerVille.php");?>
		<section>
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
				<fieldset>
					...
					<input name="countryName" value="<?php echo $countryName; ?>" placeholder="Nom du pays">

					<section>
						<!-- <input type="hidden" name="update" value="modifier"> -->
						<button type="submit" name="delete" class="lien lien_voir">Supprimer</button>
