...
<html lang="fr">
	<head>
		...
		<title>Travail dirigé 05/question 3</title>
	</head>
	<body>
		<header>
		...
		<section>
			<h2>Liste des pays du continent <?php echo $nomContinent?></h2>
			<table>
				<thead>
					<tr>
						<th>Pays</th>
				...
				<tbody>
					<?php
						foreach($paysList as $key => $value)
						{
							...
							echo "<tr>";
							echo "<td>" . $nomPays . "</td>"; //nom du pays
							echo "<td>";
							...
							echo "<input type='hidden' name='nomPays' value='$nomPays'>";
							// Affiche un bouton de soumission du formulaire
							echo "<button type='submit' class='lien lien_voir'>Voir villes</button>"; 
